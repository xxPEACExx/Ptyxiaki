...
#                         # ✅ Εισαγωγή στην DB
#                         cursor.execute("""
#                             INSERT INTO parties (did, last_name, sequence, city, format, state)
#                             VALUES (%s, %s, %s, %s, %s, %s)
#                         """, (did, last_name, sequence, city, format_id, state_id))
#                         count += 1
#
#     db.commit()
#     print(f"✅ Εισήχθησαν {count} εγγραφές με state για DID: {did}")
